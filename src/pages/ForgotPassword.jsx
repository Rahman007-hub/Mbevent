...
const ForgotPassword = () => {
  ...
  const url = "https://mbevent-server.onrender.com/api/v1/forgot-password";
  ...
  return (
    <div className="vh-100 d-flex justify-content-center align-items-center reset-container">
      <form onSubmit={handleSubmit(onSubmit)} className="p-2 position-relative">
        ...
        <ActionBtn
          width={"100%"}
          content={isSubmitting ? "Resetting Password..." : "Reset Pasword"}
          type="submit"
          className={isSubmitting ? "mt-2 bg-secondary" : "special mt-2"}
